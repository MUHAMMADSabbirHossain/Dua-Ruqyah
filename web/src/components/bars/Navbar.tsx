...
const Navbar = () => {
  return (
    <nav>
      {/* Responsive - Desktop: left navbar, Mobile: bottom navbar */}
      <div
        className="fixed z-20 flex items-center bg-[#EEF6EB] border-[#E1EBE1] 
                     lg:w-[68px] lg:h-screen lg:left-0 lg:top-0 lg:flex-col lg:border-r
                     w-full h-16 left-0 bottom-0 flex-row justify-evenly border-t backdrop-blur-sm lg:bg-[#EEF6EB]"
      >
        {/* Dua Icon - Desktop view */}
        <div className="mt-3 mb-8 hidden lg:block">
          <Link
            href="#"
            className="w-[44px] h-[44px] bg-[#417360] rounded-xl flex items-center justify-center"
          >
            <svg
              width="29"
              height="20"
        ...
        <div
          className="flex lg:mt-[43px] lg:flex-col lg:items-center lg:space-y-6 lg:flex-1 lg:justify-center 
                  md:max-w-[380px] flex-row justify-evenly w-full lg:w-auto lg:space-x-0 space-x-0"
        >
          {/* Home Icon */}
          <Link
            href="#"
            className={`w-10 h-10 lg:rounded-xl flex items-center justify-center transition-all lg:bg-transparent`}
          >
            <svg
              width="24"
              height="24"
        ...
        {/* Bottom Icons - Trophy and Menu - Desktop view */}
        <div className="mb-3 hidden lg:flex flex-col items-center space-y-4">
          <button
            className={`w-10 h-[60px] rounded-xl flex items-center justify-center transition-all`}
          >
            <svg
              width="24"
              height="24"
