...
const CategorySearchBar = ({ handleScrollToDua, category, subCategory, duaBySubCategoryId }) => {

    return (
        <section className='mx-5 min-w-80 hidden lg:block text-lg max-h-[calc(80vh)] overflow-y-scroll rounded-2xl'>
